...
We're excited to announce **Aixgo v0.2.5**, featuring a significant infrastructure improvement: the Aixgo website has been consolidated into the main repository as a monorepo. This
change streamlines development and improves the contributor experience.

## What Changed

The Aixgo website source code, previously maintained in a separate `aixgo-dev/web` repository, now lives at `web/` in the main [aixgo-dev/aixgo](https://github.com/aixgo-dev/aixgo)
repository.
