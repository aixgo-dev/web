...
date: 2025-12-26
description:
  'Aixgo v0.2.0 brings major improvements to the VertexAI provider with Google Gen AI SDK migration, production hardening fixes, enhanced security with SSRF protection, and
  streamlined CI/CD workflows.'
tags: ['release', 'vertexai', 'security', 'production', 'google-cloud']
author: 'Aixgo Team'
---

**Aixgo v0.2.0** focuses on production readiness, security hardening, and developer experience. This release brings a major upgrade to our VertexAI provider, critical stability
fixes, and enhanced security features.
